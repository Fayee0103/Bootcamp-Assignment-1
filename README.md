...
Wealthsimple could automate and optimize the lending process by deploying an auto-underwriting and auto-funding engine. The underwriting and decisioning model utilize machine learning algorithms, e.g. decision tree, unsupervised clustering, to profile clients and build adjudication models. Smart contracts can be utilized to execute the funding process to ensure all the terms and conditions are met and validated.
